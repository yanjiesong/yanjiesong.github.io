...
**Journal Articles**
<ol>
<li><b>Song, Y.</b>, Ou, J., Pedrycz, W., Suganthan, P. N., Wang, X., Xing, L., & Zhang, Y. (2024). Generalized Model and Deep Reinforcement Learning-Based Evolutionary Method for Multitype Satellite Observation Scheduling. IEEE Transactions on Systems, Man, and Cybernetics: Systems.</li>
<li>Wei, L., Chen, M., Xing, L., Wan, Q., <b>Song, Y.</b>, Chen, Y., & Chen, Y. (2024). Knowledge-transfer based genetic programming algorithm for multi-objective dynamic agile earth observation satellite scheduling problem. Swarm and Evolutionary Computation, 101460.</li>
...
<li>Liu, S., Wang, J., Wang, R., Zhang, Y., <b>Song, Y.</b>, & Xing, L. (2023). Data-driven dynamic pricing and inventory management of an omni-channel retailer in an uncertain demand environment. Expert Systems with Applications, 122948.<a href="https://github.com/yanjiesong/yanjiesong.github.io/blob/master/files/eswa2023.pdf"> [pdf]</a></li>
<li> Wu, J., Cheng, L., Chu, S., & <b>Song, Y</b>. (2024). An autonomous coverage path planning algorithm for maritime search and rescue of persons-in-water based on deep reinforcement learning. Ocean Engineering, 291, 116403.<a href="https://github.com/yanjiesong/yanjiesong.github.io/blob/master/files/oe2023.pdf"> [pdf]</a></li>
<li> Tan, W., Tian, H., <b>Song, Y.</b>, & Duan, X. (2023). Impact of Allee and fear effects in a fractional order prey–predator system with group defense and prey refuge. Chaos: An Interdisciplinary Journal of Nonlinear Science, 33(10).<a href="https://github.com/yanjiesong/yanjiesong.github.io/blob/master/files/chaos2023.pdf"> [pdf]</a></li>
...
<li>A Tabu-Based Bees Algorithm for Unmanned Aerial Vehicles in Maritime Search and Rescue Path Planning (Forthcoming)</li>
<li>A Knowledge Transfer-based Bees Algorithm for	Expert Team Formation Problem in Internet	Company (Forthcoming)</li>
