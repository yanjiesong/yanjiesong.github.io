...
**Journal Articles**
<ol>
<li>Song, Y., Ou, J., Pedrycz, W., Suganthan, P. N., Wang, X., Xing, L., & Zhang, Y. (2024). Generalized Model and Deep Reinforcement Learning-Based Evolutionary Method for Multitype Satellite Observation Scheduling. IEEE Transactions on Systems, Man, and Cybernetics: Systems.</li>
<li>Wei, L., Chen, M., Xing, L., Wan, Q., Song, Y., Chen, Y., & Chen, Y. (2024). Knowledge-transfer based genetic programming algorithm for multi-objective dynamic agile earth observation satellite scheduling problem. Swarm and Evolutionary Computation, 101460.</li>
